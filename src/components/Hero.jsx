...
const Home = () => {
  return (
    <section id='home'>
      {/* Flex Container */}
      <div className='container flex flex-col-reverse items-center px-6 mx-auto space-y-0 md:space-y-0 md:flex-row w-[1519px] h-[721px] bg-cover' style={{backgroundImage: `url(${BackgroundImage})`}}>
        {/* Left Item */}
