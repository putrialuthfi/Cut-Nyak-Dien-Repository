    ...
    <div className="flex flex-col items-center">
      <div className="flex justify-center mb-7">
        <button
          ...
          className={`text-header3 font-bold w-full flex justify-center items-center px-4 py-2 rounded-tl-lg rounded-bl-lg focus:outline-none ${activeButton === 'parent' ? 'bg-primary text-white' : 'bg-third text-third'}`}
