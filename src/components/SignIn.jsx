  ...
  return (
    <div className="flex h-screen flex-wrap box-border">
      <div className="w-full md:w-1/2 bg-gray-100 flex items-center justify-center">
        <img src={image} alt="" className="w-full h-auto md:h-full object-cover" />
      </div>
      ...
      <div className="w-full md:w-1/2 bg-white p-10 flex flex-col items-center">
        ...
        <footer className="w-full text-center text-primary text-header3 mt-4">
          <p>Belum Punya Akun? <span className="font-bold">Daftar Disini</span></p>
        </footer>
      </div>
    </div>
  );
