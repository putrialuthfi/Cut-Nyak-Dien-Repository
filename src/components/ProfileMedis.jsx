            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-center gap-5'>
                ...
                <div className='rounded-xl shadow-lg'>
                    <div className=' flex flex-col h-[380px]'>
                        ...
                        <a href='#' className='mx-auto text-center border mt-5 border-stone-950 text-black rounded-lg font-semibold h-[35px] w-[200px] flex items-center justify-center'>Lihat Profil</a>
                    </div>
                </div>
