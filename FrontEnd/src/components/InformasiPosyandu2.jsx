...
const InformasiPosyandu2 = () => {
  return (
    <div className="informasiposyandu2">
      <Navbar />
      <div className="profile-section w-full gap-5 md:px-10 px-4">
        <div className="flex flex-col md:flex-row mt-14">
          ...
          <div className="profile-details text-left md:w-1/2 leading-8 p-4">
        ...
        {/* Schedule Section */}
        <div className="schedule-section text-center mt-20 mb-14">
          <h2 className="schedule-title text-2xl font-bold mb-8">Jadwal Kegiatan</h2>  
          <div className="flex flex-wrap justify-center gap-8">
            {/* card 1 */}
            <div className="w-full md:w-80 h-full p-4 max-w-sm rounded-3xl overflow-hidden shadow-lg border border-[#76ABAE]">
              <div className="p-4">
                <h3 className="font-semibold"><strong>Konsultasi Gizi dan Pemberian Suplemen</strong></h3>
            ...
            <div className="w-full md:w-80 h-full p-4 max-w-sm rounded-3xl overflow-hidden shadow-lg border border-[#76ABAE]">
              <div className="p-4">     
                <h3 className="font-semibold"><strong>Penimbangan Balita dan Imunisasi</strong></h3>
                <p className="text-sm text-left mt-4">
            ...
            <div className="w-full md:w-80 h-full p-4 max-w-sm rounded-3xl overflow-hidden shadow-lg border border-[#76ABAE]">
              <div className="p-4">
                <h3 className="font-semibold"><strong>Pemeriksaan Kesehatan Ibu Hamil</strong></h3>
                <p className="text-sm text-left mt-4">
