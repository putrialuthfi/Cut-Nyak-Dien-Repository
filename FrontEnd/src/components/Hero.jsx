...
const Home = () => {
  return (
    <section id='home'>
      {/* Flex Container */}
      <div className='w-full flex flex-col-reverse items-center px-6 mx-auto space-y-0 md:space-y-0 md:flex-row h-[700px] bg-cover' style={{backgroundImage: `url(${BackgroundImage})`}}>
        {/* Left Item */}
        <div className='flex flex-col mb-12 space-y-6 md:w-1/2'>
